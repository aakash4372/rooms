        ...
        <div className="container mx-auto px-6 grid md:grid-cols-4 gap-8">
          ...
          <div>
            <ul className="space-y-2 text-left">
              ...
              {["Single Image", "HDR Blend", "Flash Ambient", "Hand Made Blend", "Drone Shoot Edit", "Sky and Grass Replace", "Remove Wire and Pool", "Twilight Edit", "Day to Dusk", "360 Images", "Staging", "Video"].map((work, index) => (
                <li key={index}>
                  <a
          ...
          <div>
            <ul className="space-y-3 text-left">
              ...
              <li className="flex space-x-5 mt-4">
                <a href="https://api.whatsapp.com/send?phone=916381583810" target="_blank" rel="noopener noreferrer">
                  <img src="img/whatsapp.png" alt="WhatsApp" className="h-8" />
                </a>
                <a href="https://www.instagram.com/rainpic_infotech/" target="_blank" rel="noopener noreferrer">
                  <img src="img/instagram.png" alt="Instagram" className="h-8" />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61574584262474" target="_blank" rel="noopener noreferrer">
